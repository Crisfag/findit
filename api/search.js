      ...
      try {
        ...
        const isImgSearch = isImageSearch;
          const scoreInstruction = isImgSearch
            ? "RECHERCHE PAR IMAGE. Score chaque produit (0-99) selon sa ressemblance avec l'image. " +
              "PRIORITE: 1. TYPE/CATEGORIE du produit (si c'est un squishy, tous les squishies ont au moins 60). " +
              "2. FORME similaire +10pts. 3. COULEUR similaire +5pts. 4. MATIERE similaire +5pts. " +
              "BAREME: meme type + forme similaire = 75-85. Meme type + quelques similitudes = 60-75. " +
              "Meme type variante differente = 45-60. Meme categorie produit different = 30-45. Sans rapport = moins de 30. " +
              "NE PAS penaliser les variantes normales (couleurs differentes = OK). " +
              "Criteres visuels detectes: " + visualCriteria.join(', ')
            : "Recherche: \"" + q + "\". Criteres: " + visualCriteria.join(', ') + ". Score chaque produit (0-99). Un produit qui correspond bien doit avoir au moins 60. Penalise seulement les produits hors sujet.";
